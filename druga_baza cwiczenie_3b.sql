...
Select * from pytania;
Select tresc, answer, kategoria from pytania where answer = 'b'
order by kategoria asc limit 5;
Select tresc, rok from pytania where rok = 2008 limit 7;
Select kategoria, Count(*) from pytania where kategoria = 'programowanie';
Select Count(*) from pytania where rok < 2010;
Select answer, Count(*) from pytania where answer = 'd';
Select Count(*) from pytania where tresc like '%algorytm%';
