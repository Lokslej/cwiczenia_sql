...
Select * from pytania;
Select tresc from pytania where id = 15;
Select tresc from pytania where answer ='a';
Select tresc from pytania where rok = 2007;
Select tresc from pytania where rok = 2009 and kategoria ='programowanie';
Select tresc, odpa, odpb, odpc, odpd from pytania where rok = 2010;
Select tresc from pytania order by tresc asc;
Select tresc from pytania where id between 10 and 12;
Select tresc from pytania where tresc like 'Jak%';
Select tresc from pytania where tresc like '%C++%';
